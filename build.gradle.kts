...
dependencies {
    ...
    compileOnly("io.github.selevinia:selevinia-spring-boot-starter-data-tarantool:0.3.2")
    compileOnly("io.github.selevinia:selevinia-spring-boot-starter-data-tarantool-reactive:0.3.2")
    ...
    testImplementation("io.github.selevinia:selevinia-spring-boot-starter-data-tarantool:0.3.2")
    testImplementation("io.github.selevinia:selevinia-spring-boot-starter-data-tarantool-reactive:0.3.2")
